...
const respVisita = document.querySelector("#outVisita")
...
function contadorVisita(){
    ...
    if(contador == 1){
        respVisita.innerText = "Muito bem vindo! Essa é sua primeira visita ao nosso site"
    }
    else {
        respVisita.innerText = `Que bom que você voltou! Esta é sua visita de número ${contador} ao nosso site.`
    }
